...
/**
 * Unchecked variant of {@link HadoopIOException}.
 *
 * @author Jerry Xiong
 */
public class HadoopIOException extends RuntimeException {
     ...
     * Public constructor.
     */
    public HadoopIOException(String msg) {
        super(msg);
    }
     ...
     * Public constructor.
     */
    public HadoopIOException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
