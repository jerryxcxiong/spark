...
/**
 * Created by Jerry Xiong on 13/10/15.
 * Defines the public methods that each Deep configuration object should implement.
 *
 * @param <T> the generic type associated to this configuration object.
 */
public interface IJobConfig<T, S extends IJobConfig<?, ?>> extends Serializable {
